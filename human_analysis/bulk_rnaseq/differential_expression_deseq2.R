#!/usr/bin/env Rscript
# Differential expression with DESeq2: DMD vs Healthy.
# Input: gene_counts.matrix.txt (from featureCounts). Output: results and plots in out_dir.
# Requires: DESeq2, tidyverse, org.Hs.eg.db, ReactomePA, msigdbr, glue, readr.
...
# --- Sample metadata and low-count filter ---
