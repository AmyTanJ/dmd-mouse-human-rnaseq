#!/usr/bin/env bash
# Run FastQC on FASTQ files and optionally aggregate with MultiQC.
# Input: FASTQ_DIR (default ./humanDMD/2nd_DMD/FASTQ)
# Output: QC reports in FASTQ_DIR/QC; multiqc_report.html if MultiQC is installed.
# Requires: fastqc; optional: multiqc (pip install multiqc)
set -euo pipefail
